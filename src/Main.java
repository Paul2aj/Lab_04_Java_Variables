...
void main() {
    ...
    double doubleOperandA = 4.75;
    double doubleOperandB = 2.35;
    double doubleSum = 7.1;
    double doubleProduct = 11.16;
    double doubleDifference = 2.4;
    double doubleQuotient = 2.02;

    // INT OPERATIONS AND OUTPUTS//
